      ...
      snap-x snap-mandatory z-20'>
        {projects.map((project, i) => (
          ...
          '>
            ...
            src="Image/airoffice-project.png" alt="Air Office" />
            ...
            <p className='text-lg text-center md:text-left'>
              ...
              adipisicing elit. Numquam repellendus expedita
              dignissimos provident necessitatibus! Explicabo,
              cupiditate molestiae, dolor doloribus fuga deserunt
              suscipit repellendus voluptatibus magnam, expedita
              excepturi quos inventore porro!
            </p>
          </div>
        )
        )}
